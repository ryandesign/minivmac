...
#pragma segment MetrowerksSupport
...
static void WriteDocTypeMWAddFile(void)
{
	WriteBeginXMLtagLine("FILE");
		WriteXMLtagBeginValEndLine("PATHTYPE", "Name");
		WriteXMLtagBeginProcValEndLine("PATH", WriteDocTypeIconFileName);
		WriteXMLtagBeginValEndLine("PATHFORMAT", "MacOS");
		WriteXMLtagBeginValEndLine("FILEKIND", "Unknown");
		WriteXMLtagBeginValEndLine("FILEFLAGS", "");
	WriteEndXMLtagLine("FILE");
...
static void WriteMetrowerksSpecificFiles(void)
{
	...
	WriteBeginXMLtagLine("TARGET");
		...
		WriteBeginXMLtagLine("SETTINGLIST");
			...
			if (cur_targ == gbk_targ_wx86) {
				...
				if (gbo_dbg == gbk_dbg_on) {
					...
					WriteXMLtagSettingNameVal("GlobalOptimizer_X86_optimizationlevel", "Level1");
					/*
						Level4 (and Level3 and Level2) generates bade code.
					*/
				}
				...
				if (gbo_dbg == gbk_dbg_on) {
					...
					WriteXMLtagSettingNameVal("GlobalOptimizer_X86__optimizationlevel", "Level1");
				}
		...
		} /* (cur_targ == gbk_targ_mach) || (cur_targ == gbk_targ_imch) */
