...
#define ReallocateHandle ReallocHandle

/* From Files.h */

#define PBWriteSync(paramBlock) PBWrite(paramBlock, false)
#define PBReadSync(paramBlock) PBRead(paramBlock, false)
#define PBGetVolSync(paramBlock) PBGetVol(paramBlock, false)
#define PBHGetVolSync(paramBlock) PBHGetVol(paramBlock, false)
#define PBOpenSync(paramBlock) PBOpen(paramBlock, false)
#define PBHOpenSync(paramBlock) PBHOpen(paramBlock, false)
#define PBOpenRFSync(paramBlock) PBOpenRF(paramBlock, false)
#define PBHOpenRFSync(paramBlock) PBHOpenRF(paramBlock, false)
#define PBCreateSync(paramBlock) PBCreate(paramBlock, false)
#define PBHCreateSync(paramBlock) PBHCreate(paramBlock, false)
#define PBDirCreateSync(paramBlock) PBDirCreate(paramBlock, false)
#define PBDeleteSync(paramBlock) PBDelete(paramBlock, false)
#define PBHDeleteSync(paramBlock) PBHDelete(paramBlock, false)
#define PBGetFInfoSync(paramBlock) PBGetFInfo(paramBlock, false)
#define PBHGetFInfoSync(paramBlock) PBHGetFInfo(paramBlock, false)
#define PBSetFInfoSync(paramBlock) PBSetFInfo(paramBlock, false)
#define PBHSetFInfoSync(paramBlock) PBHSetFInfo(paramBlock, false)
#define PBGetFCBInfoSync(paramBlock) PBGetFCBInfo(paramBlock, false)
...
#define GetControlMaximum GetCtlMax
#define SetControlMaximum SetCtlMax
#define GetControlValue GetCtlValue
#define SetControlValue SetCtlValue
#define kControlIndicatorPart inThumb
#define kControlUpButtonPart inUpButton
#define kControlDownButtonPart inDownButton
#define kControlPageUpPart inPageUp
#define kControlPageDownPart inPageDown
...
#define TEGetScrapLength TEGetScrapLen
#define clickLoop clikLoop
#define TEClickLoopUPP ClikLoopProcPtr

/* From Dialogs.h */

#define ResetAlertStage ResetAlrtStage
