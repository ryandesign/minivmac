...
LOCALPROC WriteMVCMakeFile(void)
{
	...
	WriteBlankLineToDestFile();
	vCheckWriteDestErr(DoAllSrcFilesWithSetup(DoMVCSrcFileMakeCompile));

	WriteBlankLineToDestFile();
	vCheckWriteDestErr(DoAllSrcFilesWithSetup(DoMVCSrcFileMakeAsm));
