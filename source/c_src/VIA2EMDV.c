...
#ifndef VIA2_ORA_FloatVal
#define VIA2_ORA_FloatVal 0xFF
#endif

#ifndef VIA2_ORB_FloatVal
#define VIA2_ORB_FloatVal 0xFF
#endif

#ifndef VIA2_ORA_CanIn
#define VIA2_ORA_CanIn 0x00
#endif

#ifndef VIA2_ORA_CanOut
#define VIA2_ORA_CanOut 0x00
#endif

#ifndef VIA2_ORB_CanIn
#define VIA2_ORB_CanIn 0x00
#endif

#ifndef VIA2_ORB_CanOut
#define VIA2_ORB_CanOut 0x00
#endif

#ifndef VIA2_IER_Never0
#define VIA2_IER_Never0 0xFF
#endif

#ifndef VIA2_IER_Never1
#define VIA2_IER_Never1 0xFF
#endif

#ifndef VIA2_CB2modesAllowed
#define VIA2_CB2modesAllowed 0x01
#endif

#ifndef VIA2_CA2modesAllowed
...
#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 7) || Ui3rTestBit(VIA2_ORA_CanOut, 7))
#ifdef VIA2_iA7
#error "VIA2_iA7 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 6) || Ui3rTestBit(VIA2_ORA_CanOut, 6))
#ifdef VIA2_iA6
#error "VIA2_iA6 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 5) || Ui3rTestBit(VIA2_ORA_CanOut, 5))
#ifdef VIA2_iA5
...
#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 4) || Ui3rTestBit(VIA2_ORA_CanOut, 4))
#ifdef VIA2_iA4
#error "VIA2_iA4 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 3) || Ui3rTestBit(VIA2_ORA_CanOut, 3))
#ifdef VIA2_iA3
#error "VIA2_iA3 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 2) || Ui3rTestBit(VIA2_ORA_CanOut, 2))
#ifdef VIA2_iA2
#error "VIA2_iA2 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 1) || Ui3rTestBit(VIA2_ORA_CanOut, 1))
#ifdef VIA2_iA1
#error "VIA2_iA1 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORA_CanIn, 0) || Ui3rTestBit(VIA2_ORA_CanOut, 0))
#ifdef VIA2_iA0
#error "VIA2_iA0 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 7) || Ui3rTestBit(VIA2_ORB_CanOut, 7))
#ifdef VIA2_iB7
#error "VIA2_iB7 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 6) || Ui3rTestBit(VIA2_ORB_CanOut, 6))
#ifdef VIA2_iB6
#error "VIA2_iB6 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 5) || Ui3rTestBit(VIA2_ORB_CanOut, 5))
#ifdef VIA2_iB5
...
#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 4) || Ui3rTestBit(VIA2_ORB_CanOut, 4))
#ifdef VIA2_iB4
#error "VIA2_iB4 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 3) || Ui3rTestBit(VIA2_ORB_CanOut, 3))
#ifdef VIA2_iB3
#error "VIA2_iB3 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 2) || Ui3rTestBit(VIA2_ORB_CanOut, 2))
#ifdef VIA2_iB2
#error "VIA2_iB2 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 1) || Ui3rTestBit(VIA2_ORB_CanOut, 1))
#ifdef VIA2_iB1
#error "VIA2_iB1 defined but not used"
#endif
#endif

#if ! (Ui3rTestBit(VIA2_ORB_CanIn, 0) || Ui3rTestBit(VIA2_ORB_CanOut, 0))
#ifdef VIA2_iB0
...
{
	ui3b NewInterruptRequest = ((VIA2_D.IFR & VIA2_D.IER) != 0) ? 1 : 0;
...
#endif
				VIA2_D.ACR = Data;
				if ((VIA2_D.ACR & 0x20) != 0) { /* Not pulse counting? */
					ReportAbnormal("Set VIA2_D.ACR T2 Timer pulse counting");
				}
				switch ((VIA2_D.ACR & 0xC0) >> 6) {
					/* case 1: happens in early System 6 */
					case 2:
						ReportAbnormal("Set VIA2_D.ACR T1 Timer mode 2");
						break;
				}
				CheckT1IntReady();
				switch ((VIA2_D.ACR & 0x1C) >> 2) {
					...
					case 4:
					case 5:
						ReportAbnormal("Set VIA2_D.ACR shift mode 1,2,4,5");
						break;
					default:
						break;
				}
				if ((VIA2_D.ACR & 0x03) != 0) {
					ReportAbnormal("Set VIA2_D.ACR T2 Timer latching enabled");
				}
			} else {
				Data = VIA2_D.ACR;
			}
...
#define Ui3rSetContains(s, i) (((s) & (1 << (i))) != 0)
				if (! Ui3rSetContains(VIA2_CB2modesAllowed, (VIA2_D.PCR >> 5) & 0x07)) {
					ReportAbnormal("Set VIA2_D.PCR CB2 Control mode?");
				}
				if ((VIA2_D.PCR & 0x10) != 0) {
					ReportAbnormal("Set VIA2_D.PCR CB1 INTERRUPT CONTROL?");
				}
				if (! Ui3rSetContains(VIA2_CA2modesAllowed, (VIA2_D.PCR >> 1) & 0x07)) {
					ReportAbnormal("Set VIA2_D.PCR CA2 INTERRUPT CONTROL?");
				}
				if ((VIA2_D.PCR & 0x01) != 0) {
					ReportAbnormal("Set VIA2_D.PCR CA1 INTERRUPT CONTROL?");
				}
			} else {
				Data = VIA2_D.PCR;
			}
		...
		case kIFR:
			if (WriteMem) {
				VIA2_D.IFR = VIA2_D.IFR & ((~ Data) & 0x7F); /* Clear Enable Bits */
				VIA2_CheckInterruptFlag();
				CheckT1IntReady();
			} else {
				Data = VIA2_D.IFR;
		...
		case kIER   :
			if (WriteMem) {
				if ((Data & 0x80) == 0) {
					VIA2_D.IER = VIA2_D.IER & ((~ Data) & 0x7F); /* Clear Enable Bits */
					...
					*/
					...
					VIA2_D.IER = VIA2_D.IER | (Data & 0x7F); /* Set Enable Bits */
