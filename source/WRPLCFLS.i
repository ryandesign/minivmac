...
#pragma segment PLCSupport

static void DoSrcFilePLCAddFile(void)
{
...
LOCALPROC WritePLCProjectFile(void)
{
	...
	vCheckWriteDestErr(DoAllSrcFilesWithSetup(DoSrcFilePLCAddFile));
...
LOCALFUNC tMyErr WritePLCSpecificFiles(void)
{
	return WriteADestFile(&OutputDirR,
		vStrAppAbbrev, ".ppj", WritePLCProjectFile);
}
...
LOCALFUNC tMyErr WritePLCclSpecificFiles(void)
{
	return WriteADestFile(&OutputDirR,
		"Makefile", "", WritePLCclMakeFile);
}
