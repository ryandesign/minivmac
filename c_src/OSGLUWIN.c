/*
	...
	Copyright (C) 2001 Philip Cummins, Weston Pawlowski, Paul Pratt
...
/*--- windows resource file ids ---*/

#include "../win_res/resource.h"
...
static blnr AllocateMacRAM(void)
{
	...
	RAM = (UWORD *)GlobalAlloc(GMEM_FIXED, kRAM_Size);
	if (RAM == NULL) {
...
{
/*
	this little bit of code makes the program 10K larger
*/
	time_t ltime;
	...
	if (GetTimeZoneInformation(&TimeZoneInformation) != -1) {
		ltime -= (TimeZoneInformation.Bias * 60);
	}
	return (ULONG)(ltime + 2082844800);
}
